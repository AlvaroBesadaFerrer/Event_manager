...
def show_details(event):
    ...
    return {
        ...
        "start_time": datetime_to_str(event.start_time),
        "end_time": datetime_to_str(event.end_time),
    }
...
def show_resources_details():
    ...
    for e in events:
        ...
        event_info = f"{e.event_type.name}, {datetime_to_str(e.start_time) if e.start_time else 'N/A'}, {datetime_to_str(e.end_time) if e.end_time else 'N/A'}"
