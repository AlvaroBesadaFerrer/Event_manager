...
RESOURCES = [
    ...
    Resource("protection_1", "Guantes", ResourcesType.Herramienta),
    Resource("protection_2", "Careta", ResourcesType.Herramienta),
    Resource("protection_3", "Lentes de seguridad", ResourcesType.Herramienta),
